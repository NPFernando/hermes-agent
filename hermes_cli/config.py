...
DEFAULT_CONFIG = {
    ...
    "fallback_providers": [],
    "harp_routing": {
        # Universal HARP selector integration gate for gateway runtime
        # resolution. Defaults off to preserve existing behavior.
        "enabled": False,
        # Optional explicit selector path. When empty, runtime discovery
        # checks UNIVERSAL_HARP_SELECTOR_SCRIPT and known install paths.
        "selector_script": "",
        # Routing context forwarded to the selector.
        "task": "code_generation",
        "risk": "standard",
        # Hard timeout for selector execution.
        "timeout_seconds": 5,
        # In-memory rolling history size used for /harp-status visibility.
        "history_size": 20,
        "history_max_age_days": 14,
        # Auto-disable guardrail: after N failed selector/provider-resolution
        # outcomes within the time window, Hermes flips harp_routing.enabled
        # to false in config.yaml to fail closed back to default routing.
        "auto_disable_failure_threshold": 5,
        "auto_disable_window_seconds": 300,
        # Per-provider cooldown weighting: effective cooldown for a provider
        # is base + provider_penalties[provider] seconds.
        "provider_cooldown_base_seconds": 0,
        "provider_penalties": {},
        "provider_penalty_decay": "fixed",  # fixed|linear|exponential
        # Optional home-channel alerts when auto-disable triggers.
        "alert_on_auto_disable": False,
        "alert_history_size": 50,
        # Optional critical-only webhook sink for alert automation/audits.
        "alert_webhook_url": "",
        "alert_webhook_secret": "",
        "alert_webhook_timeout_seconds": 5,
        "alert_webhook_max_retries": 2,
        "alert_webhook_max_skew_seconds": 300,
        "alert_export_signing_secret": "",
        "alert_export_signing_key_id": "",
        "alert_export_signing_key_version": "v1",
        "alert_export_signing_key_deprecated": False,
        "alert_export_signing_not_before": "",
        "alert_export_signing_sunset_at": "",
        "severity_state_max_age_seconds": 86400,
        "severity_state_max_keys": 200,
        "lint_history_size": 100,
        "severity_reset_admin_tags": [],
        "severity_reset_audit_size": 200,
        "severity_reset_reason_deny_regex": "",
        "severity_reset_allowed_reasons": [],
        "severity_reset_reason_redact_regex": "",
        "severity_reset_reason_privileged_tags": [],
        "severity_reset_reason_partial_tags": [],
        "severity_reset_reason_preview_chars": 12,
        "severity_reset_audit_retention_days": 30,
        "severity_reset_cursor_signing_secret": "",
        ...
        "severity_reset_unmute_reason_redact_regex": "",
        "severity_reset_top_unmute_actors_limit": 5,
        "severity_reset_verify_audit_size": 100,
        "severity_reset_actor_normalization_regex_map": {},
        "severity_reset_verify_nonce_window_seconds": 3600,
        "severity_reset_verify_nonce_cache_size": 1000,
        "severity_reset_verify_allowed_verifiers": [],
        "severity_reset_verifier_normalization_regex_map": {},
        ...
        # Cooldown policy to auto-reenable after clean operation.
...
_KNOWN_ROOT_KEYS = {
    ...
    "fallback_providers", "harp_routing", "credential_pool_strategies", "toolsets",
